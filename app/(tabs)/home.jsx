...
import {getUserEmail, getUserID, updateUser} from '../../config';
...
const Home = () => {
  ...
  // useEffect(()=>{
  //   try{
  //     getUserEmail(user.email).then(user => getUserID(user._id)
  //     .then(user =>
  //       updateUser({
  //       id:user._id, currentLocation:[location.latitude, location.longitude]
  //     })
  //   )).then(getUserEmail(user.email).then(user => setCurrentUser({
  //       id: user._id,
  //       username: user.username,
  //       email: user.email,
  //       password: user.password,
  ...
  // const currentUser = {id:'1', email:'eee', username:'sdfsd',password:'xxx',calendars:[],currentLocation:""}\
  ...
  return (
    ...
    //               <LocationChecker 
    //                 address="9404 113th st, Richmond Hill, NY" 
    //                 radius={500} 
    //               />
    //             </View>
    //           </View>
